package cn.iocoder.yudao.module.system.controller.app.verification.vo;

import io.swagger.v3.oas.annotations.media.Schema;
import jakarta.validation.constraints.NotNull;
import lombok.Data;

@Schema(description = "APP - 二次验证请求 VO")
@Data
public class AppSecondaryVerificationReqVO {

    @Schema(description = "验证类型: 1-密码 2-短信验证码", requiredMode = Schema.RequiredMode.REQUIRED, example = "2")
